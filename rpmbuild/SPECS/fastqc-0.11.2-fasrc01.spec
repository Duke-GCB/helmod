...
#
%define summary_static A quality control tool for high throughput sequence data.
...
rm -rf FastQC
unzip "$FASRCSW_DEV"/rpmbuild/SOURCES/%{name}_v%{version}.zip
cd FastQC
...
umask 022
cd "$FASRCSW_DEV"/rpmbuild/BUILD/FastQC
