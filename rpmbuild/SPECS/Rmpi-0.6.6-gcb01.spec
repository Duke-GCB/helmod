...
%define builddependencies R/3.4.0-gcb01 openmpi/1.10.7-gcb01
...
#
%description
Rmpi module that allows running R over OpenMPI.
...
echo 'install.packages("Rmpi", lib="%{_prefix}", repos="http://cran.us.r-project.org", configure.args=c("--with-mpi=${MPI_HOME} --with-Rmpi-include=${MPI_HOME}/include --with-Rmpi-libpath=${MPI_HOME}/lib --with-Rmpi-type=${RMPI_TYPE}"), configure.vars=c("CPPFLAGS=-I${MPI_HOME}/include LDFLAGS=-L${MPI_HOME}/lib"))' | R --vanilla
