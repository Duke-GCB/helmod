...
#
%define summary_static the GNU Compiler Collection version 4.9.3
...
# applicable
#
URL: https://ftp.gnu.org/gnu/gcc/gcc-4.9.3/gcc-4.9.3.tar.gz
...
prepend_path("CPATH",              "%{_prefix}/lib64/gcc/x86_64-unknown-linux-gnu/4.9.3/include")
prepend_path("CPATH",              "%{_prefix}/lib64/gcc/x86_64-unknown-linux-gnu/4.9.3/install-tools/include")
prepend_path("CPATH",              "%{_prefix}/lib64/gcc/x86_64-unknown-linux-gnu/4.9.3/plugin/include")
prepend_path("CPATH",              "%{_prefix}/include")
prepend_path("FPATH",              "%{_prefix}/lib64/gcc/x86_64-unknown-linux-gnu/4.9.3/include")
prepend_path("FPATH",              "%{_prefix}/lib64/gcc/x86_64-unknown-linux-gnu/4.9.3/install-tools/include")
prepend_path("FPATH",              "%{_prefix}/lib64/gcc/x86_64-unknown-linux-gnu/4.9.3/plugin/include")
